  ...
  <body class="" >
  	<!-- Container div -->
  		...
  		<div class="pt-7 pb-15 px-16 text-black">
  			...
  			<!-- Strillo destra -->
  			<div class="text-3xl leading-7 font-semibold w-1/2 tracking-widest ml-auto pb-15">
  				<h1 class=" w-4/5">
  				MILANO DESIGN WEEK
  				7/12 GIU. 22
  				</h1>
  			...
  			<!-- Strillo sinistra -->
  			<div class="text-3xl leading-7 font-semibold w-7/12 tracking-widest mr-auto ">
  				<h2>
    	...
    	<p class="text-3xl leading-7 font-semibold w-1/2 tracking-widest">
  	 	INSIDE<br>
    	LOOKING<br>
    	OUT<br>
    	</p>

    	<p class="text-3xl leading-7 font-semibold w-1/2 tracking-widest pt-7">
