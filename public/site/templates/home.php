  ...
  <body class="w-screen" >
	...
	<div>
		...
		<div class="h-76 md:h-42p w-full overflow-hidden relative">
			...
			<div class="absolute w-full pl-16 md:pl-0 md:right-0 p-3 inset-y-0 flex md:w-1/2 align-center z-10 text-black font-bold text-8vh leading-7vh tracking-widest">
		...
		<div class="h-42p w-full overflow-hidden relative">
			...
			<div class="absolute pl-16 md:left-0 inset-y-0 flex  w-full md:w-1/2 align-center z-10 text-white font-bold text-8vh leading-7vh tracking-widest">
				<div class="self-center w-1/2">
