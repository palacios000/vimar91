	...
	<div>
		...
		<div class="h-29p sm-2:h-42p w-full overflow-hidden relative">
			...
			<div class="absolute w-full pl-8 sm-2:pl-0 sm-2:right-0 p-3 inset-y-0 flex sm-2:w-1/2 md:w-1/2 align-center z-10 text-black text-banner-mobile sm-2:text-8vh sm-2:leading-7vh tracking-widest">
				<div class="self-center w-2/5 sm:w-3/5 sm-2:w-1/2">
		...
		<!-- Third banner -->
		<div class="h-29p sm-2:h-42p w-full overflow-hidden relative">
			<img class="object-cover h-29p sm-2:h-42p w-full z-0" src="<?= $config->urls->templates ?>pictures/3-crop.jpg" alt="flower banner">
			<div class="absolute w-full pl-8 sm-2:pl-0 sm-2:right-0 p-3 inset-y-0 flex sm-2:w-1/2 md:w-1/2 align-center z-10 text-white text-banner-mobile sm-2:text-8vh sm-2:leading-7vh tracking-widest">
				<div class="self-center w-2/5 sm:w-3/5 sm-2:w-1/2">
					SWINGING AFRICA
				</div>
			</div>
