...
<div class="flex bg-white h-15p mt-auto px-16 sticky top-0 z-50">
			...
			<div class="hidden sm:visible sm:flex flex-row gap-x-3 my-auto ml-auto uppercase text-grigio-chiaro text-menu  tracking-widest">
			...
			<!-- Menu button -->
			<div class="visible sm:hidden uppercase text-6vh text-grigio-chiaro my-auto ml-auto ">
				<div class="pl-3.5 hover:text-gray-700 ease-in-out duration-100">
					<a href=" ">
						Menu
					</a>
